...
(async function () {
  const ICONS = {
    ...
    'Cultist': 'i-cultist',
    'Demon': 'i-demon',
    'Doppelganger': 'i-doppelganger',
    "Frankenstein's-Monster-type Creation": 'i-frankensteins-monster-type-creation',
    'Gargoyle': 'i-gargoyle',
    'Ghost Shark': 'i-ghost-shark',
    'Ghoul': 'i-ghoul',
    'Giant Hair Monster': 'i-giant-hair-monster',
    'Giant Spider': 'i-giant-spider',
    'Giant Wasp': 'i-giant-wasp',
    'Grim Reaper': 'i-grim-reaper',
    'Head of the House': 'i-head-of-the-house',
    'Hellhound': 'i-hellhound',
    'Locust/Insect Swarm': 'i-locust-insect-swarm',
    'Masked Slasher': 'i-masked-slasher',
    'Mummy': 'i-mummy',
    'Killer Clown': 'i-killer-clown',
    'Plague Doctor': 'i-plague-doctor',
    'Poltergeist': 'i-poltergeist',
    'Possessed Doll': 'i-possessed-doll',
    'Rat Swarm': 'i-rat-swarm',
    'Revenant': 'i-revenant',
    'Scarecrow': 'i-scarecrow',
    'Sea Monster/Kraken': 'i-sea-monster-kraken',
    'Security Robot': 'i-security-robot',
    'Shadow Figure': 'i-shadow-figure',
    'Skeleton': 'i-skeleton',
    'Spirit': 'i-spirit',
    'Vampire': 'i-vampire',
    'Werewolf': 'i-werewolf',
